...
public class MCLBasedProjectionsTwoNorm implements Projector{
	private double inflationParameter = 1.5;
	private boolean verbose = true;
	
	public MCLBasedProjectionsTwoNorm(double inflationParameter, boolean verbose){
	...
	public Set<Set<String>> getProjections(XLog log){
		...
		Set<Set<XEventClass>> clustering = dfpg.applyMCLusteringAggregatorMLE(l2Aggregator, inflationParameter);
