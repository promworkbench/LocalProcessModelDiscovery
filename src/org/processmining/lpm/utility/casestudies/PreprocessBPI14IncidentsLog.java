...
@Plugin(
		name = "Preprocess BPI'14 Incidents Log", 
		parameterLabels = {"BPI'14 Incidents Log"}, 
	    returnLabels = {"Preprocessed BPI'14 Incidents Log"}, 
	    returnTypes = { XLog.class }
		)
public class PreprocessBPI14IncidentsLog{
	public final String utilityName = "# Related Interactions";
	
	@UITopiaVariant(affiliation = UITopiaVariant.EHV, author = "N. Tax", email = "n.tax@tue.nl")
	@PluginVariant(variantLabel = "Preprocess BPI'14 Incidents Log", requiredParameterLabels = {0})
