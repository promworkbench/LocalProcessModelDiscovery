...
@Plugin(
		name = "Filter Local Process Model ranking for Diversification", 
...
public class FilterForDiversification{
	...
	public LocalProcessModelRanking filter(PluginContext context, LocalProcessModelRanking nets) {
		return filterHeadless(nets, DIVERSITY_THRESHOLD);
	}
	
	public static LocalProcessModelRanking filterHeadless(LocalProcessModelRanking nets, double diversity_threshold) {
